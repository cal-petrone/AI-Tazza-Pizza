...
10. Be conversational and friendly, not robotic
        ...
        tools: [
          {
            ...
            parameters: {
              ...
              properties: {
                ...
                size: {
                  type: 'string',
                  description: 'Size of the item (small, medium, large, regular)',
    ...
    try {
      ...
      switch (functionName) {
        case 'add_item_to_order':
          ...
          console.log(`✓ Added to order: ${args.quantity || 1}x ${args.size || 'regular'} ${args.name}`);
          break;
